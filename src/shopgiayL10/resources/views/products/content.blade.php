...
@section('content')
    ...
    <section class="sec-product-detail bg0 p-t-65 p-b-60">
            ...
            <div class="row">
                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 800px;">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <span class="mtext-106 cl2"><p style="font-family: 'Arial, sans-serif'; font-size:25px">Giá gốc: <del>{!! \App\Helpers\Helper::price($product->price) !!} VNĐ</del></p>
						</span>
                        <br>
                        <span class="mtext-106 cl2"><p style="font-family: 'Arial, sans-serif'; font-size:25px; color: red;">Giá giảm: {!! \App\Helpers\Helper::price($product->price_sale) !!} VNĐ</p>
						</span>
                        <br>
                        <p>
                        ...
                        <br>
                        <p>
                           Mô tả chi tiết: {{ $product->content }}
                        </p>
        ...
        <div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
            ...
            <span class="stext-301 cl6 p-b-30">
